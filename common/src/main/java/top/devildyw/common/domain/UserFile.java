...
//    public UserFile(NGFile NGFile, long userId, String fileId) {
//        this.userFileId = IdUtil.getSnowflakeNextIdStr();
//        this.userId = userId;
//        this.fileId = fileId;
//        this.filePath = NGFile.getParent();
//        this.fileName = NGFile.getNameNotExtend();
//        this.extendName = NGFile.getExtendName();
//        this.isDir = NGFile.isDirectory() ? 1 : 0;
